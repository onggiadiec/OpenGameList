                ...
                <div class="panel-body">
                    <form class="item-detail-edit">
                        ...
                        <div class="form-group has-feedback" [ngClass]="{'has-success':
                            ...
                            <input id="input-title" name="input-title" type="text" class="formcontrol" [(ngModel)]="item.Title" placeholder="Insert the title..."
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="input-description" name="inputdescription" class="form-control" [(ngModel)]="item.Description"
